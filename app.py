...
from pages.CaesarPage import CaesarPage
from pages.MultiplicativePage import MultiplicativePage
from pages.AffinePage import AffinePage
...
class MainPage(QWidget):
    ...
    def __init__(self, stack):
        ...
        button1 = QPushButton("Caesar Encryption")
        button2 = QPushButton("Multiplicative Encryption")
        button3 = QPushButton("Affine Encryption")
...
class MainWindow(QStackedWidget):
    def __init__(self):
        ...
        self.setWindowTitle("Multi Encryption Application")
        self.setGeometry(0, 0, 1366, 768)

        # Create pages
        self.main_page = MainPage(self)
        self.page1 = CaesarPage(self)
        self.page2 = MultiplicativePage(self)
        self.page3 = AffinePage(self)
